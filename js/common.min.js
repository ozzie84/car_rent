...
!function(e){WebFont.load({google:{families:["Jura:300,400,500,600,700,800"]}}),e(document).ready(function(){setTimeout(function(){e(window).scrollTop(0),e(".sk-overlay").slideUp(600)},2500)}),e(".slider").slick({accessibility:!1,autoplay:!0,autoplaySpeed:5e3,pauseOnHover:!0,arrows:!1});var a=e(".header-overlay"),l=e("#nav-icon1"),t=e(".lang a"),o=e(".header-overlay__menu a"),i=e("#btn1");e.scrollUp(null,800),i.click(function(){e.scrollUp("scroll")}),e(window).on("load resize",function(){e(window).width()>="767"&&(l.removeClass("open"),a.stop(!0).animate({left:"-100%"},700))}),l.click(function(){i.toggleClass(),e(this).toggleClass("open"),e(this).hasClass("open")?a.stop(!0).animate({left:"0",display:"block"},700):(a.stop(!0).animate({left:"-100%"},700),o.removeClass("active"))}),t.click(function(){e(this).parent().children().removeClass("active"),e(this).addClass("active")}),o.click(function(){e(this).parent().children().removeClass("active"),e(this).addClass("active")}),e('.header-overlay__menu a[href^="#"]').on("click",function(){var a=this;e("html, body").animate({scrollTop:e(e(a).attr("href")).offset().top-60},1e3)}),e('.header__menu > a[href^="#"]').on("click",function(){var a=this;e("html, body").animate({scrollTop:e(e(a).attr("href")).offset().top},1e3)}),e(".gallery-modal").remodal();var n=e(".gallery-list__btn"),r=e("[data-remodal-id=form-modal]").remodal();e(".gallery-list__env[data-id]").on("click",function(){var a=e(this).data("id");e(".gallery-modal[data-id="+a+"]").remodal().open(),e(".description-envelope__img").attr("src",e(this).find("img").attr("src"))}),n.on("click",function(){r.open()}),e("#date-range").datepicker({timepicker:!0,range:!0,language:"ru"}),e(".masked_tel").mask("+000 (000) 00-00-00")}(jQuery);